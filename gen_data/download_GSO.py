# Usage
#     python3 download_GSO.py -o <collection_owner> -c <collection_name>
# TO　DOWNLOAD GSO DATASET    <<=======ATTENTION======>>
#     python3 download_GSO.py -o "GoogleResearch" -c "Scanned Objects by Google Research"
# Description
